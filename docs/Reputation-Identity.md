...
```
Your WorldWideSwarm identity mnemonic (write this down, keep it offline):
...
Rotation announcement published to GossipSub topic `/wws/1.0.0/key-rotation` and
...
```
topic: /wws/1.0.0/name-expiry-warning
